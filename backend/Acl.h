...
class Acl
{
  public:
    struct Cols
    {
        static const std::string _aclid;
     ...
     */
    explicit Acl(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit Acl(const Json::Value &pJson) noexcept(false);
     ...
     */
    Acl(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
    ...
    /**  For column aclid  */
    ///Get the value of the column aclid, returns the default value if the column is null
    const int64_t &getValueOfAclid() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<int64_t> &getAclid() const noexcept;
    ///Set the value of the column aclid
    void setAclid(const int64_t &pAclid) noexcept;
    ...
    const short &getValueOfPermission() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<short> &getPermission() const noexcept;
    ///Set the value of the column permission
    void setPermission(const short &pPermission) noexcept;
  ...
  private:
    friend drogon::orm::Mapper<Acl>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<Acl>;
#endif
  ...
  public:
    ...
    {
        static const std::string sql="select * from " + tableName + " where aclid = $1";
        return sql;
    }

    static const std::string &sqlForDeletingByPrimaryKey()
    {
        static const std::string sql="delete from " + tableName + " where aclid = $1";
        return sql;
    }
