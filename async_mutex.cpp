...
stend::async_mutex::async_mutex() noexcept
	: m_state(not_locked)
	, m_waiters(nullptr)
{}

stend::async_mutex::~async_mutex()
{
...
bool stend::async_mutex::try_lock() noexcept
{
...
stend::async_mutex_lock_operation stend::async_mutex::lock_async() noexcept
{
	return async_mutex_lock_operation{ *this };
}

stend::async_mutex_scoped_lock_operation stend::async_mutex::scoped_lock_async() noexcept
{
	return async_mutex_scoped_lock_operation{ *this };
}

void stend::async_mutex::unlock()
{
...
bool stend::async_mutex_lock_operation::await_suspend(std::coroutine_handle<> awaiter) noexcept
{
	m_awaiter = awaiter;
